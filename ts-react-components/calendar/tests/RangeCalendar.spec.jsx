...
describe("RangeCalendar", () => {
  ...
  it("next month works", () => {
    ...
    wrapper
      ...
      .simulate("click");
    expect(
      currentEndMonth.add(1, "month").isSame(wrapper.state("value")[1], "month")
    ).toBe(true);
    expect(
    ...
    expect(
      wrapper.find(".rc-calendar-range-left .rc-calendar-next-month-btn").length
    ).toBe(0);
  });
  ...
  it("next year works", () => {
    ...
    expect(
      wrapper.find(".rc-calendar-range-right .rc-calendar-prev-year-btn").length
    ).toBe(1);
  ...
  it("right panel show prev btns when left panel show year panel or month panel", () => {
    ...
    wrapper
      ...
      .simulate("click");
    expect(
      wrapper.find(".rc-calendar-range-right .rc-calendar-next-year-btn").length
    ).toBe(1);
    expect(
  ...
  it("key control", () => {
    ...
    const keySimulateCheck = (code, month, date, info) => {
      ...
      expect(
        wrapper.find(".rc-calendar-range-left .rc-calendar-month-select").text()
